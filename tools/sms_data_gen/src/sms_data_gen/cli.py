...
def parse_args() -> CliArgs:
    ...
    parser.add_argument("-p", "--sprite-palette", metavar="sprite palette", dest="sprite_palette", help="initial sprite palette colors in hex, comma separated")
    ...
    return CliArgs(
        sprite_pallette=args.sprite_palette,
